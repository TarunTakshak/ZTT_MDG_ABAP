*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZTT_CL_V_DEPE_A
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZTT_CL_V_DEPE_A     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZTT_CL_V_DEPE_A'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZTT_CL_V_DEPE_A_EXTRACT
TOTAL = ZTT_CL_V_DEPE_A_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZTT_CL_V_DEPE_A'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZTT_CL_V_DEPE_A-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZTT_CL_V_DEPE_A_EXTRACT
TOTAL = ZTT_CL_V_DEPE_A_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZTT_CL_V_DEPE_A-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZTT_CL_V_DEPE_A'
...
TOTAL = ZTT_CL_V_DEPE_A_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZTT_CL_V_DEPE_A-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZTT_CL_V_DEPE_A-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZTT_CL_V_DEPE_A'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZTT_CL_V_DEPE_A-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZTT_CL_V_DEPE_A_EXTRACT
TOTAL = ZTT_CL_V_DEPE_A_TOTAL
